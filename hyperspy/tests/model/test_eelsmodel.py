...
class TestCreateEELSModel(object):
    ...
    def test_auto_add_edges_true(self):
        ...
        nose.tools.assert_true(u"B_K" in cnames and u"C_K" in cnames)

    def test_gos(self):
        m = self.s.create_model(auto_add_edges=True, GOS=u"hydrogenic")
        nose.tools.assert_true(m[u"B_K"].GOS._name == u"hydrogenic")
    ...
    def test_auto_add_edges_false_names(self):
        ...
        cnames = [component.name for component in m]
        nose.tools.assert_false(u"B_K" in cnames or u"C_K" in cnames)
...
class TestEELSModel(object):
    ...
    def test_suspend_auto_fsw(self):
        m = self.m
        m[u"B_K"].fine_structure_width = 140.
        m.suspend_auto_fine_structure_width()
        m.enable_fine_structure()
        m.resolve_fine_structure()
        nose.tools.assert_equal(140, m[u"B_K"].fine_structure_width)
...
class TestFitBackground(object):
    ...
    def test_fit_background_B_C(self):
        ...
        nose.tools.assert_almost_equal(self.m[u"Offset"].offset.value,
                                       1)
        nose.tools.assert_true(self.m[u"B_K"].active)
        nose.tools.assert_true(self.m[u"C_K"].active)
    ...
    def test_fit_background_C(self):
        ...
        nose.tools.assert_almost_equal(self.m[u"Offset"].offset.value,
                                       1.71212121212)
        nose.tools.assert_false(self.m[u"B_K"].active)
        nose.tools.assert_true(self.m[u"C_K"].active)
    ...
    def test_fit_background_no_edge(self):
        ...
        nose.tools.assert_almost_equal(self.m[u"Offset"].offset.value,
                                       2.13567839196)
        nose.tools.assert_false(self.m[u"B_K"].active)
        nose.tools.assert_false(self.m[u"C_K"].active)
